...
class StructuredLogger:
    ...
    Provides clear separation of execution stages and better readability.
    """
    ...
    def step_retry(self, step_num: int, step_name: str, attempt: int, max_attempts: int):
        """Log step retry."""
        self.logger.warning(f"[STEP {step_num:2d}] {step_name} - RETRY {attempt}/{max_attempts}")
    ...
    def automation_end(self, automation_name: str, success: bool, summary: Optional[dict] = None):
        """Log automation end."""
        self.info("")
